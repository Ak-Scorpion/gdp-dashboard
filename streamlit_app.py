...
st.set_page_config(
    page_title="KI Form- & Risiko-Wettengine",
    page_icon="⚽",
    layout="wide",
...
# ============================================================
# HINTERGRUND-FORM- UND RISIKO-ANALYSE
# ============================================================
...
st.markdown('<div class="main-title">⚽ KI Form- & Risiko-Wettengine</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Echtzeit-Daten, automatische Formanalyse im Hintergrund & intelligenter Schein-Generator.</div>', unsafe_allow_html=True)
...
if uploaded_files:
    ...
    st.success("✅ Screenshots eingelesen. Die KI filtert und analysiert die Partien im Hintergrund.")
    st.markdown("---")
...
if analyze_btn or uploaded_files:
    if not analyzed_matches:
        ...
        st.markdown(f"## 🎯 Generierter KI-Wettschein")
        ...
        st.markdown("---")
        st.markdown("### 📋 Hintergrund-Formanalyse der Partien")
    ...
    st.info("👈 Wähle deine Kriterien in der Sidebar und klicke auf 'KI-Analyse starten & Schein bauen'.")
